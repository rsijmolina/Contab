        ...
        If Not boBuscando Then
            If DataNavBarPrincipal.NuevoRegistro = False Then
                ...
                If IsNothing(LineaDatosRow) Then
                    Me.CTTransaccionesDetalleTableAdapter.Fill(Me.CTTransaccionesDataSet.CTTransaccionesDetalle, 0)
                    Totalizar()
                    Exit Sub
                Else
                    ...
                    Me.CTTransaccionesDetalleTableAdapter.Fill(Me.CTTransaccionesDataSet.CTTransaccionesDetalle, LineaDatosRow("ID"))
