Public Class EditDataNavBar
    ...
    Private _HabilitarCancelar As Boolean
    Public Property HabilitarCancelar() As Boolean
        Get
            Return _HabilitarCancelar
        End Get
        Set(ByVal value As Boolean)
            _HabilitarCancelar = value
            Me.ToolStripButCancelarPrestamo.Visible = value
        End Set
    End Property
    ...
    Property BindingSourcePrincipal() As BindingSource
        ...
        End Set
    End Property
    Private _BotonImprimirVisible As Boolean
    Public Property BotonImprimirVisible() As Boolean
        Get
            Return _BotonImprimirVisible
        End Get
        Set(ByVal value As Boolean)
            ToolStripButImprimir.Visible = value
            _BotonImprimirVisible = value
        End Set
    End Property
    ...
    Public Event EstCtaClick(ByVal sender As Object, ByVal e As EventArgs)
    ...
    End Sub
    Private Sub ToolStripButAnular_Click(sender As Object, e As EventArgs) Handles ToolStripButAnular.Click
    ...
    End Sub
    Private Sub ToolStripButtonEstCta_Click(sender As Object, e As EventArgs) Handles ToolStripButtonEstCta.Click
        RaiseEvent EstCtaClick(Me, e)
    End Sub
    Private Sub ToolStripButCancelarPrestamo_Click(sender As Object, e As EventArgs) Handles ToolStripButCancelarPrestamo.Click
        RaiseEvent CancelarClick(Me, e)
    End Sub
    Private Sub ToolStripButImprimir_Click(sender As Object, e As EventArgs) Handles ToolStripButImprimir.Click
    ...
    Public Sub HabilitarBotones(mForma As Windows.Forms.Form)
        ...
        If Modalidad = "CONSULTAR" Then
            ...
            ToolStripButAnular.Visible = False
        ...
        ElseIf Modalidad = "ELIMINAR" Then
            ...
            ToolStripButAnular.Visible = False
            ControlesSoloLectura(mForma)
        ElseIf Modalidad = "Anular" Then
            ToolStripButtonGuardar.Visible = False
            ToolStripButtonEliminar.Visible = False
            ToolStripButAnular.Visible = True
            ToolStripButtonEstCta.Visible = True
            ControlesSoloLectura(mForma)
        End If
    End Sub
    Private Sub BloquearControles(ByVal mParent As Control, ByVal Bloquear As Boolean)
        ...
        For Each mControl In mParent.Controls
            ...
            If mControl.GetType.FullName = "C1.Win.C1TrueDBGrid.C1TrueDBGrid" Then
                mc1dbgrd = mControl
                mc1dbgrd.AllowUpdate = IIf(Bloquear = False, True, False)
            End If
        Next
    ...
    Private Sub ToolStripBotones_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles ToolStripBotones.ItemClicked
