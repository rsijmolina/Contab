Public Class CTClass
    ...
    Public Function ObtenerNoTransaccion() As Int32
        ...
        End Try
    End Function
    Public Function ObtenerFechaProceso() As Date
        Dim cnSQLConexion As SqlClient.SqlConnection
        Dim cmdInComando As SqlClient.SqlCommand
        ...
        Try
            ...
            cmdInComando = cnSQLConexion.CreateCommand
            cmdInComando.CommandType = CommandType.Text
            cmdInComando.CommandText = "SELECT FechaProceso FROM CTConf"
            drConf = cmdInComando.ExecuteReader
            drConf.Read()
            ObtenerFechaProceso = drConf("FechaProceso")
            cnSQLConexion.Close()
